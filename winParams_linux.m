function varargout = winParams_linux(varargin)
% WINPARAMS_LINUX MATLAB code for winParams_linux.fig
%      WINPARAMS_LINUX, by itself, creates a new WINPARAMS_LINUX or raises the existing
%      singleton*.
%
%      H = WINPARAMS_LINUX returns the handle to a new WINPARAMS_LINUX or the handle to
%      the existing singleton*.
%
%      WINPARAMS_LINUX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WINPARAMS_LINUX.M with the given input arguments.
%
%      WINPARAMS_LINUX('Property','Value',...) creates a new WINPARAMS_LINUX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before winParams_linux_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to winParams_linux_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help winParams_linux

% Last Modified by GUIDE v2.5 17-Apr-2018 16:47:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @winParams_linux_OpeningFcn, ...
                   'gui_OutputFcn',  @winParams_linux_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% update fields according to given winParams_linux
...
% update winParams_linux and axPreview according to fields
...
% --- Executes just before winParams_linux is made visible.
function winParams_linux_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to winParams_linux (see VARARGIN)
...
% Choose default command line output for winParams_linux
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes winParams_linux wait for user response (see UIRESUME)
uiwait(handles.figParams);


% --- Outputs from this function are returned to the command line.
function varargout = winParams_linux_OutputFcn(hObject, eventdata, handles) 
